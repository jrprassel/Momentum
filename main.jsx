...
function getTodayKey() {
  // Convert current time to EST (UTC-5) or EDT (UTC-4)
  const now = new Date();
  // Get EST offset: EST is UTC-5, EDT is UTC-4
  // We'll use a fixed UTC-5 offset to keep it simple and consistent
  ...
  // Day rolls over at 4am EST
  if (estDate.getHours() < 4) {
